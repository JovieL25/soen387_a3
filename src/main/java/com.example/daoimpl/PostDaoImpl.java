...
public class PostDaoImpl implements PostDAO {
    ...
    public boolean createPost(Post post) {
        ...
        try{
            String query = "INSERT INTO posts (user_id,title,post_date,update_date,text,updated,group) VALUES (?, ?, ?, ?, ?, ?,?)";
    ...
    public boolean updatePost(Post post) {
        ...
        try {
            PreparedStatement ps = connection.prepareStatement("UPDATE posts SET user_id=?, title=?,post_date=?,update_date=?,text=?,updated=?,group=? WHERE post_id=?");
